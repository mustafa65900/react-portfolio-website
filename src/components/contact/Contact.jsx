      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Gmail</h4>
            <h5>mustafanadeem659@gmail.com</h5>
            <a href="mailto:mustafanadeem659@gmail.com" target="_blank">Send a Mail</a>
          </article>
          ...
          <article className="contact__option">
            ...
            <h4>WhatsApp</h4>
            <h5>+91 9763730050</h5>
            <a href="https://wa.me/9763730050" target="_blank">Message Me</a>
          </article>
